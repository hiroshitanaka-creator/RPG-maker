...
依頼者が他のAIで作った参考画像10枚を、見た目の目標とする。リポジトリの `docs/reference/visual-targets/` に置き、ゲームの素材としては使わない。町・村・ダンジョンを作るときは、対応する目標の絵と並べて比べる。

| ファイル | 手本にする場所 |
| --- | --- |
| `village-farm-a.jpg`、`village-farm-b.jpg` | わら屋根の農村（ミルフェ村など、小さな村） |
| `town-walled-a.jpg`、`town-walled-b.jpg`、`town-river.jpg` | 石垣と噴水のある町（中くらいの町） |
| `castle-town.jpg` | 城と城壁のある城下町 |
| `capital-city.jpg` | 市場と城のある大きな都 |
| `dungeon-stone.jpg` | 城の地下・塔・石造りのダンジョン |
| `cave-natural.jpg` | 地底湖のある自然の洞窟（ソルダ洞窟など） |
...
暗く沈まない、深みのある自然な色にする。蛍光色のような強い彩度は避ける。
屋外は、濃淡のある自然な緑の草地に、土・小石・花の色を細かく混ぜる。水は澄んだ青にする。
暗くするのは、洞窟や地下など場面に理由があるときだけ。その場合も、たいまつなどの明かりで見やすさを保つ。

### 町・村・城

規模によって作りを変える。小さな村はわら屋根の家・畑・井戸・わら山、中くらいの町は石垣・石畳・噴水・店、城下町は城壁・塔・城、大きな都は市場の屋台・教会・城を持つ。
道はゆるく曲げ、草地との境目は自然にぼかす。碁盤の目のような区画にしない。
家ごとに庭・柵・たる・木箱・花壇などの小物を置き、何もない空き地を広く残さない。
建物の外観（屋根・壁・扉・窓）を置き、扉から入ると建物の中に切り替わる。屋根の素材（わら・赤い瓦・青い石）で、場所の格が分かるようにする。
建物の中は床・壁・家具（机・椅子・棚・寝台・たる・つぼ）で作る。店はカウンター越しに店員が立ち、宿屋には受付と寝台がある。
村には住人を4〜6人以上置き、一部は決まった範囲を歩き回る。話しかけると、こちらを向く。
外周は、森・石垣・川と橋などで自然に囲む。

### 世界マップ

草原・森・山・川・橋・道・海岸を描き分ける。
地形の境目（草と森、草と山、川岸）は自然な形にし、四角い塊や一直線の川にしない。
...
石造りの地下は、石積みの壁で部屋と通路を区切り、たいまつ・扉・階段・たる・木箱を置く。
自然の洞窟は、岩の縁を曲がりくねった形にし、地底湖・石筍・光るきのこ・たき火・つり橋などを置く。
遺跡は、苔や草の生えた石の床と壁に、柱・石碑・水場を置く。
...
地形・建物・家具・宝箱・門・拠点アイコン・人物・敵・戦闘背景を、描き込まれた一つの絵柄にそろえる。単純な記号のような絵を混ぜない。
仲間4人（カイナ・リオネ・ハルド・スイナ）の設定画（全身の正面と横向き、顔）は、2026年9月26日に依頼者が採用して固定した。以降の人物の絵は、すべてこれに合わせる。
