...
> **2026年9月25日：ゲームの形を改訂した。** 世界マップを土台に城・町・村・洞窟・塔・ダンジョンを攻略して進む形へ作り替える。仕様は [体験仕様 v2](docs/experience-spec-v2.md)。以下の説明のうち「世界地図へ」「本編へ」などの旧構造は、改訂後の実装で置き換える予定であり、まだ置き換わっていない。
