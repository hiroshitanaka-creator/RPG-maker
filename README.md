...
60時間向けの長編は、現在5連作20話と12件の設置・回収を制作し、選択・戦闘・保存・手帳へ接続している。[20話時点の検査記録](docs/long-campaign-progress-20.md)を参照する。未制作60話と固有の探索・装置・育成判断が残るため、本番の新規開始では長編をまだ有効にしていない。通常起動できることと、60時間を狙う内容がそろったことは分けて扱う。
